...
const BudgetWisePrivacyPolicy: NextPage = () => {
  return (
    <div style={{ padding: '20px 50px' }}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to BudgetWise, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BudgetWise.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: erkanshelby@gmail.com</li>
      </ul>
    </div>
  );
};

export default BudgetWisePrivacyPolicy;
